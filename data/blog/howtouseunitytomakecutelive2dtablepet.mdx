...
先看一下效果：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200714000728641.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200714000816978.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
# 准备工作
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713231050741.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
3. 调整相机和live2d对象的角度和位置（下面是我的参数，没必要照搬）
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713231857362.png#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713231816491.png#pic_center)
4. 运行游戏看看，与小姐姐互动一下，看看程序是否正常运行
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713232240709.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
# 背景透明
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200714092912984.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70)
有3个参数需要设置
  Window Width：桌宠宽度
  Window Height：桌宠高度
  StrProduct：程序名（需要与Player Setting里的游戏名一致，设置方法见下图）
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713234337956.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
将相机的Clear Flagss设置为Solid Color，颜色选择黑色。
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200713234201638.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
