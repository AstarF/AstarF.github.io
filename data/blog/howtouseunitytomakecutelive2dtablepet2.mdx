...
先来看看效果：
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020090116345768.gif#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200901163521674.gif#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200901163938664.gif#pic_center)
...
运行程序应该有下面的效果
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200831223105874.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
...
```
相机参数：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200831233755592.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)


注意代码中strProduct一定要与Inspector种的Product Name一致，否则会出现奇怪的Bug（**很重要，可能会影响unity导出的同名程序使用**）。
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020083123291324.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
效果如下：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200831234055919.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
可以看到背景是透明的，而且不妨碍鼠标网页的交互。

# 屏幕自适应
桌宠不能挡在中间影响我们正常使用电脑，我们需要让她处于右下角的位置并适应屏幕分辨率。首先我们需要把相机的Projection调整为Orthographic，
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200901165357904.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
...
效果如下：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200901121447276.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200901001714537.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JlRHJlYW1tZQ==,size_16,color_FFFFFF,t_70#pic_center)
***
